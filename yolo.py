...
class YoloDetector:
    def __init__(self, 
        ...
        print(f"Loading model_id={model_id}, image_size={image_size}, conf_threshold={conf_threshold} ...")
        model_downloader.download(model_id)
...
if __name__ == "__main__":
    detector = YoloDetector("yolov10n", 640, 0.25, device="cuda")
